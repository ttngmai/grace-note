import { themeTextSizeAtom } from '@renderer/store'
import { useAtom } from 'jotai'
import CustomSelect from '../common/CustomSelect'

export default function ThemeTextSizeSelector(): JSX.Element {
  const [textSize, setTextSize] = useAtom(themeTextSizeAtom)
