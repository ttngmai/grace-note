import { bibleVerseViewerAtom } from '@renderer/store'
...
type BibleVerseViewerStylesModalProps = {
  onClose: () => void
}

export default function BibleVerseViewerStylesModal({
  onClose
}: BibleVerseViewerStylesModalProps): JSX.Element {
  const [settings, setSettings] = useAtom(bibleVerseViewerAtom)
